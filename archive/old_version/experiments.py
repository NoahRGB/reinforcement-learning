...
warnings.filterwarnings("ignore", category=UserWarning, module="pygame.pkgdata") # shuts pygame up
...
# env = GymEnvironment("Pendulum-v1", NUM_ENVS, render_mode=None, normalise_obs=True)
...
# env = GymEnvironment("custom/RNNAntEnv-v0", NUM_ENVS, render_mode=None, normalise_obs=False)
...
# agent = DQNAgent(device, logger, job_title=TITLE, lr=0.001, conv=True,
#                  replay_memory_size=1000, replay_warmup_length=0,
#                  C=1000, minibatch_size=32, gamma=0.99,
...
# agent = SACAgent(device, logger, job_title=TITLE, lr=0.001, gamma=0.99, rand_steps=100, replay_memory_size=1000000,
#                  minibatch_size=256, update_freq=1, alpha_start=1.0, target_factor=0.005,
#                  decay_steps=None, decay_rate=None, save_nn=False, load_path=None,)

# agent = PPOAgent(device, logger, job_title=TITLE, lr=0.0005, gamma=0.99, lam=0.95,
#                conv=False, cont=True, tmax=30, epsilon=0.2, epochs=10, minibatch_size=64, 
#                decay_steps=None, decay_rate=None, value_weight=0.5, entropy_weight=0.001, clip_grad_norm=0.5,
#                save_nn=False, load_path=None,)

agent = A2CAgent(device, logger, job_title=TITLE, lr=0.0003, gamma=0.99, lam=0.95, rmsprop_eps=1e-5,
               conv=False, cont=False, tmax=30, decay_steps=None, decay_rate=None,
               value_weight=0.5, entropy_weight=0.001, clip_grad_norm=0.5,
