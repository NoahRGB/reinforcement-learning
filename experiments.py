...
# agent = PPOAgent(device, logger, job_title=TITLE, lr=0.001, gamma=0.9, lam=0.95,
#                conv=False, cont=True, tmax=1024, epsilon=0.2, epochs=10, minibatch_size=64, 
#                decay_steps=None, decay_rate=None, value_weight=0.5, entropy_weight=0.0, clip_grad_norm=0.5,
#                save_nn=False, load_path=None,)

agent = A2CAgent(device, logger, job_title=TITLE, lr=0.0007, gamma=0.99, lam=1.0, rmsprop_eps=1e-5,
               conv=False, cont=True, tmax=5, decay_steps=None, decay_rate=None,
