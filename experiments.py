...
# =============== agent =================
agent = ReinforceBaselineAgent(policy_lr=0.0001, state_value_lr=0.0001, gamma=1.0, normalise=False)
# agent = ReinforceAgent(lr=(2**(-14)), gamma=0.99, normalise=False)
...
# agent = SemigradientSarsaAgent(normalise=False, lr=0.0001, epsilon=0.9, gamma=0.99, decay_rate=1.0)
