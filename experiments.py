...
env = VectorisedAtariEnvironment(name="ALE/Pong-v5", num_envs=NUM_ENVS, render_mode=None)
...
agent = ConvA2CAgent(device, writer, lr=0.0001, gamma=0.99, tmax=20, entropy_weight=0.01, clip_grad_norm=0.1)
# agent = A2CAgent(device, writer, lr=0.001, gamma=0.99, tmax=10, entropy_weight=0.1)
